...
- DASO: Distribution-Aware Semantics-Oriented Pseudo-label for Imbalanced SSL.
...
- Explanation Consistency Training: Facilitating Consistency-Based SSL with Interpretability.
  [[pdf]](https://www.aaai.org/AAAI21Papers/AAAI-7186.HanT.pdf)
  - Tao Han, Wei-Wei Tu, Yu-Feng Li. *AAAI 2021*

- In Defense of Pseudo-Labeling: An Uncertainty-Aware Pseudo-label Selection Framework for SSL.
